...
public class CadastroVeiculo extends AppCompatActivity implements View.OnClickListener {
    ...
    private void salvarCadastro(View view){
        ...
        String x = (String) Marca.getSelectedItem();
        long id = Marca.getSelectedItemId();
        int posicao = Marca.getSelectedItemPosition();

        Toast.makeText(this,"Marca: "+ x, Toast.LENGTH_LONG).show();
